...
<head>
	...
	<link rel="stylesheet" href="css/stty.css" ?v=<?php echo time(); ?>">
</head>
...
<body>
	...
	<section class="hero">
		...
		<div class="h">
            ...
            <img src="images1/Screenshot 2022-11-26 160223.png" >
        ...
        <video id="vbg" poster="pstr.png" autoplay muted loop><source src="food.webm" type="video/webm">
